<?php
/**
 * LogPageNotFound connector script
 *
...
$corePath = $modx->getOption('logpagenotfound.core_path',null,$modx->getOption('core_path').'components/logpagenotfound/');
$modx->getService('logpagenotfound', 'LogPageNotFound', $corePath.'model/logpagenotfound/');

$modx->lexicon->load('logpagenotfound:default');

/* handle request */
$path = $modx->getOption('processorsPath',$modx->logpagenotfound->config,$corePath.'processors/');
