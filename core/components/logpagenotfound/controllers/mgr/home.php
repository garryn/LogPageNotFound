 ...
 * @subpackage controllers
 */
$modx->regClientStartupScript($logPageNotFound->config['jsUrl'].'mgr/widgets/pages_by_count.grid.js');
$modx->regClientStartupScript($logPageNotFound->config['jsUrl'].'mgr/widgets/home.panel.js');
$modx->regClientStartupScript($logPageNotFound->config['jsUrl'].'mgr/sections/home.js');
$output = '<div id="logpagenotfound-panel-home-div"></div>';
